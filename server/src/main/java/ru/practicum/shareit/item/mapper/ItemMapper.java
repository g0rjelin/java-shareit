...
public class ItemMapper {
    ...
    public static Item toItem(ItemShortDto itemShortDto, User owner, ItemRequest itemRequest) {
        return Item.builder()
    ...
    public static List<ItemForItemRequestDto> toItemForItemRequestDto(Collection<Item> items) {
